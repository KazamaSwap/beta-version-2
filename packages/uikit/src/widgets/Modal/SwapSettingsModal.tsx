...
import {
    ModalBackButton, ModalBody, ModalCloseButton, ModalHeader, ModalTitle, StyledModalContainer
} from './styles';
import { ModalProps } from './types';

export const MODAL_SWIPE_TO_CLOSE_VELOCITY = 300;

const SwapSettingsModal: React.FC<React.PropsWithChildren<ModalProps>> = ({
  title,
  onDismiss,
  onBack,
  children,
