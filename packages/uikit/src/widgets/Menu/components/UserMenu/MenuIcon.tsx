...
import { RefreshIcon, WalletFilledIcon, WarningIcon, RocketIcon, DefaultAvatarIcon } from "../../../../components/Svg";
...
export const NoProfileMenuIcon: React.FC<React.PropsWithChildren> = () => (
  <MenuIconWrapper borderColor="primary">
    <DefaultAvatarIcon color="primary" width="28px" />
  </MenuIconWrapper>
);
...
const MenuIcon: React.FC<React.PropsWithChildren<{ avatarSrc?: string; variant: Variant }>> = ({
  ...
  return <ProfileIcon src={avatarSrc} height={36} width={36} />;
};
