...
export const StyledCard = styled.div<StyledCardProps>`
  ...
  ${({ isActive }) =>
    isActive &&
    css`
      background: linear-gradient(180deg,#EE1979,#F79418);
    `}
...
export const StyledTablesCard = styled.div<StyledCardProps>`
...
export const TokensCardInner = styled(Box)<{ background?: string; hasCustomBorder: boolean }>`
  width: 100%;
  height: 100%;
  overflow: ${({ hasCustomBorder }) => (hasCustomBorder ? "initial" : "inherit")};
