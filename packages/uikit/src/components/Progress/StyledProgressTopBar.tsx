...
export const Bar = styled.div<ProgressBarProps>`
  ...
  background: ${({ theme, $useDark, primary, $background }) => {
    ...
    if ($useDark) return primary ? theme.colors.primary : `${theme.colors.secondary}80`;
...
interface StyledProgressTopBarProps {
  variant: ProgressProps["variant"];
  scale: ProgressProps["scale"];
  $useDark: boolean;
}

const StyledProgressTopBar = styled.div<StyledProgressTopBarProps>`
  position: relative;
...
export default StyledProgressTopBar;
