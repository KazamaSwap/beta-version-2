...
export const KAZAMA_MAINNET = new Token(
  ChainId.BSC,
  '0xd3331F83C39A10021A6118A21003fE11376dADc0',
  18,
  'KAZAMA',
  'Kazama Senshi',
  'https://kazamaswap.finance/',
)
...
export const KAZAMA_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  '0x5A22aDF67922b3A087D58735EBF9963806583116',
  18,
  'KAZAMA',
  'Kazama Senshi',
  'https://kazamaswap.finance/',
...
export const KAZAMA = {
  [ChainId.BSC]: KAZAMA_MAINNET,
  [ChainId.BSC_TESTNET]: KAZAMA_TESTNET,
}
