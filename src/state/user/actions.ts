...
import { SerializedToken } from '@kazamaswap/tokens'
...
export const updateUserAcceptedBetaRisk = createAction<{ userAcceptedBetaRisk: boolean }>(
  'user/updateUserAcceptedBetaRisk',
)
