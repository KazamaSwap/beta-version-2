...
const getFarmBaseTokenPrice = (
  ...
  if (farm.quoteToken.symbol === bscTestnetTokens.busd.symbol) {
    return hasTokenPriceVsQuote ? new BigNumber(farm.tokenPriceVsQuote) : BIG_ZERO
  }

  if (farm.quoteToken.symbol === bscTestnetTokens.wbnb.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === bscTestnetTokens.wbnb.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === bscTestnetTokens.busd.symbol) {
