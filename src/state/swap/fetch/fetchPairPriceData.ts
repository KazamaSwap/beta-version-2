  ...
  try {
    switch (timeWindow) {
      case PairDataTimeWindowEnum.DAY: {
        const data = await request<PairHoursDatasResponse>(client, pairHourDatas, {
          pairId,
      ...
      case PairDataTimeWindowEnum.WEEK: {
        const lastPairHourIdData = await request<LastPairHourIdResponse>(client, lastPairHourId, { pairId })
        ...
        const pairHoursData = await request<PairHoursDatasResponse>(client, pairHourDatasByIds, {
          pairIds: pairHourIds,
        })
        return { data: pairHoursData, error: false }
      }
      case PairDataTimeWindowEnum.MONTH: {
        const data = await request<PairHoursDatasResponse>(client, pairDayDatas, {
          pairId,
          first: timeWindowIdsCountMapping[timeWindow],
        })
        return { data, error: false }
      ...
      case PairDataTimeWindowEnum.YEAR: {
        const lastPairDayIdData = await request<LastPairDayIdResponse>(client, lastPairDayId, { pairId })
        ...
        const pairDayData = await request<PairDayDatasResponse>(client, pairDayDatasByIdsQuery, {
          pairIds: pairDayIds,
        })
