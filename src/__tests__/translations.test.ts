...
const whitelist = [
  ...
  'Happy Niu Year! This senshi’s excited for the year of the bull (market!)',
  ...
  'These senshis love nothing more than swapping pancakes. Especially on BSC.',
  `It's raining syrup on this senshi, but he doesn't seem to mind. Can you blame him?`,
  `These senshis like their pancakes with blueberries. What's your favorite topping?`,
  "Love makes the world go 'round... but so do pancakes. And these senshis know it.",
  `It’s sparkling syrup, pancakes, and even lottery tickets! This senshi really loves it.`,
