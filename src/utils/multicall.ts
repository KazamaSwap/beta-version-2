...
const multicall = async <T = any>(abi: any[], calls: Call[], chainId = ChainId.BSC_TESTNET): Promise<T> => {
...
export const multicallv2 = async <T = any>({ abi, calls, chainId = ChainId.BSC_TESTNET, options }: MulticallV2): Promise<T> => {
