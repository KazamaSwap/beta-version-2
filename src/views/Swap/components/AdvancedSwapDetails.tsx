import { Trade, TradeType, Currency } from '@kazamaswap/sdk'
          ...
          {/* <QuestionHelper
            text={
              <>
                ...
                <Text>- {t('%amount% towards KAZAMA buyback and burn', { amount: buyBackFeePercent })}</Text>
              </>
            }
            ml="4px"
            placement="top-start"
...
export function AdvancedSwapDetails({ trade }: AdvancedSwapDetailsProps) {
  ...
  const showRoute = Boolean(trade && trade.route.path.length > 0)
