...
import { Box, ButtonMenu, ButtonMenuItem, Flex, Text } from '@kazamaswap/uikit'
...
export const ItemButton = styled(ButtonMenuItem)`
   border-radius: 8px;
`

const NoChart = styled(Text)`
color: #fff;
    font-weight: 600;
    line-height: 1.5;
    font-size: 15px;
    ...
    <>
      ...
      >
        <Flex flexDirection="column" pt="12px"> 
          ...
          />
                      <Text color={isChangePositive ? 'success' : 'failure'} fontSize="15px" ml="4px" bold>
        ...
        <Box>
          ...
          <ItemButton>{t('24H')}</ItemButton>
            <ItemButton>{t('1W')}</ItemButton>
            <ItemButton>{t('1M')}</ItemButton>
            <ItemButton>{t('1Y')}</ItemButton>
          </ButtonMenu>
        </Box>
      </Flex> 
