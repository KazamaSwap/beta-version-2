import React, { useRef, useState, useEffect, Dispatch, SetStateAction, useMemo } from 'react'
...
import { lightColors, darkColors } from '@kazamaswap/uikit'
...
const getChartColors = ({ isChangePositive }) => {
  return isChangePositive
    ...
    : { gradient1: '#ee1a78', gradient2: 'transparent', stroke: '#FF5958 ' }
}
  ...
  useEffect(() => {
    ...
    const chart = createChart(chartRef.current, {
      layout: {
        ...
        textColor: isDark ? darkColors.text : darkColors.text,
      },
      handleScale: false,
      handleScroll: false,
