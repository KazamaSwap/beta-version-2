...
interface HistoryWidgetNumbersProps extends FlexProps {
  number: string
  size?: string
  fontSize?: string
  rotateText?: boolean
...
const HistoryWidgetNumbers: React.FC<React.PropsWithChildren<HistoryWidgetNumbersProps>> = ({
  number,
  size = '32px',
  fontSize = '16px',
  rotateText,
...
export default HistoryWidgetNumbers
