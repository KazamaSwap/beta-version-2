...
import { Heading, ModalContainer, ModalHeader, ModalTitle, ModalBody, ModalCloseButton } from '@kazamaswap/uikit'
...
const SenshiDecoration = styled.div`
  position: absolute;
  top: -116px; // line up senshi at the top of the modal
  left: 0px;
  text-align: center;
  width: 100%;
`
...
const ClaimPrizesModal: React.FC<React.PropsWithChildren<ClaimPrizesModalModalProps>> = ({
  ...
  return (
    <StyledModal $minWidth="280px">
      <SenshiDecoration>
        <img src="/images/decorations/prize-senshi.png" alt="senshi decoration" height="124px" width="168px" />
      </SenshiDecoration>
      <StyledModalHeader>
        <ModalTitle>
