...
import { Box, Flex, Text, Heading, Link, Image, useMatchBreakpoints } from '@kazamaswap/uikit'
import { useTranslation } from '@kazamaswap/localization'
import useTheme from 'hooks/useTheme'
import { BallWithNumberSmall, MatchExampleA, MatchExampleB, PoolAllocationChart } from '../svgs'
...
const ExampleBalls = () => {
  ...
  return (
    <BallsContainer>
      <BallWithNumberSmall size={ballSize} fontSize={fontSize} color="yellow" number="9" />
      <BallWithNumberSmall size={ballSize} fontSize={fontSize} color="green" number="1" />
      <BallWithNumberSmall size={ballSize} fontSize={fontSize} color="aqua" number="3" />
      <BallWithNumberSmall size={ballSize} fontSize={fontSize} color="teal" number="6" />
      <BallWithNumberSmall size={ballSize} fontSize={fontSize} color="lilac" number="6" />
      <BallWithNumberSmall size={ballSize} fontSize={fontSize} color="pink" number="2" />
    </BallsContainer>
  )
}
  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, equal to 5 USD in KAZAMA per ticket.'),
    },
    {
