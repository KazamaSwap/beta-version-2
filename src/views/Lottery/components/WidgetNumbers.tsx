...
import { BallWithNumber } from '../svgs/WidgetIndex'
import { BallColor } from '../svgs/WidgetBalls'

interface WidgetNumbersProps extends FlexProps {
  number: string
  size?: string
  fontSize?: string
  rotateText?: boolean
...
const WidgetNumbers: React.FC<React.PropsWithChildren<WidgetNumbersProps>> = ({
  number,
  size = '32px',
  fontSize = '16px',
  rotateText,
