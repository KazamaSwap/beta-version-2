...
interface HistoryWidgetSwitcherProps {
  isLoading: boolean
  fromRoundId: string
  toRoundId: string
...
const HistoryWidgetSwitcher: React.FC<React.PropsWithChildren<HistoryWidgetSwitcherProps>> = ({
  isLoading,
  fromRoundId,
  toRoundId,
  mostRecentRound,
...
export default HistoryWidgetSwitcher
