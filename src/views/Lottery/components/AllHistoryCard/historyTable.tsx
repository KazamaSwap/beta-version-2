...
import { Card, Text, Skeleton, CardHeaderSmall, Box, Button, ChevronUpIcon, CardFooterSmall } from '@kazamaswap/uikit'
...
import RoundCard from '../PreviousRoundCard/RoundCard'

const StyledCardHeader = styled(CardHeaderSmall)`
  z-index: 2;
  background: #25202F;
  border-bottom: 1px ${({ theme }) => theme.colors.cardBorder} solid;
`

const StyledCardFooter = styled(CardFooterSmall)`
  z-index: 2;
  background: #25202F;
            ...
            <TableBody>
              {
                selectedLotteryNodes.map((row) => (
                  <RoundCard lotteryNodeData={row} lotteryId={row.lotteryId} />
                ))
              }
            </TableBody>
          </StyledTable>
