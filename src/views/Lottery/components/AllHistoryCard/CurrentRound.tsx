...
import {  PocketWatchIcon ,ArrowForwardIcon, KazamaFrontCard, Text, Skeleton, CardHeader, Box, CardFooter, Button, CardBody, Flex, CardRibbon } from '@kazamaswap/uikit'
import { useTranslation } from '@kazamaswap/localization'
import { useAppDispatch } from 'state'
import { useLottery, useFetchLottery } from 'state/lottery/hooks'
