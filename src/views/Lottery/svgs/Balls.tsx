...
export const LilacBall: React.FC<React.PropsWithChildren<SvgProps>> = (props) => {
  return (
    <Svg viewBox="0 0 38 38" {...props}>
      <circle cx="16" cy="16" r="16" fill="#EF2C6A" />
      <g style={{ mixBlendMode: 'multiply' }} opacity="0.1">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
export const TealBall: React.FC<React.PropsWithChildren<SvgProps>> = (props) => {
  return (
    <Svg viewBox="0 0 38 38" {...props}>
      <circle cx="16" cy="16" r="16" fill="#F24E4E" />
      <g style={{ mixBlendMode: 'multiply' }} opacity="0.1">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
export const AquaBall: React.FC<React.PropsWithChildren<SvgProps>> = (props) => {
  return (
    <Svg viewBox="0 0 38 38" {...props}>
      <circle cx="16" cy="16" r="16" fill="#F4693A" />
      <g style={{ mixBlendMode: 'multiply' }} opacity="0.1">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
export const GreenBall: React.FC<React.PropsWithChildren<SvgProps>> = (props) => {
  return (
    <Svg viewBox="0 0 38 38" {...props}>
      <circle cx="16" cy="16" r="16" fill="#F58325" />
      <g style={{ mixBlendMode: 'multiply' }} opacity="0.1">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
export const YellowBall: React.FC<React.PropsWithChildren<SvgProps>> = (props) => {
  return (
    <Svg viewBox="0 0 38 38" {...props}>
      <circle cx="16" cy="16" r="16" fill="#F79418" />
      <g style={{ mixBlendMode: 'multiply' }} opacity="0.1">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
export const BallWithNumber: React.FC<React.PropsWithChildren<BallWithNumberProps>> = ({
  ...
  return (
    <Flex alignItems="center" justifyContent="center" position="relative" mx="1px">
      <BallComponent width="38px" height="38px" />
      <BallTextWrapper>
        <BallText rotationTransform={rotationTransform} bold fontSize="24px">
          {number}
        </BallText>
      </BallTextWrapper>
    </Flex>
...
export const BallWithNumberSmall: React.FC<React.PropsWithChildren<BallWithNumberProps>> = ({
  color,
  number,
  size,
  fontSize,
  ...
  return (
      <Flex alignItems="center" justifyContent="center" position="relative" mx="2px">
        ...
        <BallTextWrapper>
          <BallText rotationTransform={rotationTransform} bold fontSize="14px">
            {number}
          </BallText>
        </BallTextWrapper>
      </Flex>
