...
import AuctionKazamaBurn from './components/AuctionKazamaBurn'
...
const KAZAMA_BURN_BG_LIGHT = 'radial-gradient(50% 79.31% at 50% 50%, #FAF9FA 0%, #EAECF4 100%)'
const KAZAMA_BURN_TOP_FILL_LIGHT = 'radial-gradient(ellipse at bottom, #f0f1f6, #EAECF4)'
const KAZAMA_BURN_BG_DARK = 'radial-gradient(103.12% 50% at 50% 50%, #152534 0%, #191326 100%)'
const KAZAMA_BURN_TOP_FILL_DARK = '#191326'
        ...
        <Flex flexDirection={['column-reverse', null, 'row']}>
          <Left>
            ...
            <Text color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid KAZAMA for the right to host a 7-day Farm on KazamaSwap.')}
            </Text>
          ...
          <Right>
            <img src="/images/decorations/auction-senshi.png" alt={t('auction senshi')} />
          </Right>
        </Flex>
      </StyledHeader>
      <>
        ...
        <PageSection
          background={theme.isDark ? KAZAMA_BURN_BG_DARK : KAZAMA_BURN_BG_LIGHT}
          index={2}
          innerProps={{ style: { width: '100%' } }}
          dividerPosition="top"
          dividerFill={{ light: KAZAMA_BURN_TOP_FILL_LIGHT, dark: KAZAMA_BURN_TOP_FILL_DARK }}
        >
          <AuctionKazamaBurn />
        </PageSection>
        <PageSection
          ...
          dividerFill={{ light: KAZAMA_BURN_BG_LIGHT, dark: KAZAMA_BURN_BG_DARK }}
          concaveDivider
          index={3}
          dividerPosition="top"
        >
