 ...
 */
const LineChartOrange = ({ data, setHoverValue, setHoverDate }: LineChartProps) => {
  const {
    ...
    <ResponsiveContainer>
      ...
      >
        ...
        <linearGradient id="gradient" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor={theme.colors.warning} stopOpacity={0.5} />
        ...
        <YAxis
          ...
          orientation="right"
          tick={{ dx: 10, fill: theme.colors.text }}
        />
        <Tooltip
        ...
        />
        <Area dataKey="value" type="monotone" stroke={theme.colors.warning} fill="url(#gradient)" strokeWidth={2} />
      </AreaChart>
    </ResponsiveContainer>
  )
}

export default LineChartOrange
