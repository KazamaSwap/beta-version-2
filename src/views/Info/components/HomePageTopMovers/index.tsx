...
import { Text, Flex, Box, CardHeader, Heading } from '@kazamaswap/uikit'
            ...
            <Box ml="16px">
              ...
              <Flex alignItems="center">
                <Text fontSize="14px" mr="6px" lineHeight="16px">
                  ${formatAmount(tokenData.priceUSDChange)}
                </Text>
...
const HomePageTopMovers: React.FC<React.PropsWithChildren> = () => {
...
export default HomePageTopMovers
