...
import { Text, Flex, Box, Card, Skeleton, Heading, CardHeader } from '@kazamaswap/uikit'
    ...
    <td key='change-id'>
            ...
            <Box ml="16px">
              ...
              <Flex alignItems="center">
                ...
                <Percent fontSize="14px" value={tokenData.liquidityUSDChange} />
              </Flex>
            </Box>
            </WinningNumbersCell>
          </td>
...
const TopLiquidityMovers: React.FC<React.PropsWithChildren> = () => {
  ...
  const topPriceIncrease = useMemo(() => {
    return Object.values(allTokens)
      .sort(({ data: a }, { data: b }) => {
        ...
        return a && b ? (Math.abs(a?.liquidityUSD) > Math.abs(b?.liquidityUSD) ? -1 : 1) : -1
      })
...
export default TopLiquidityMovers
