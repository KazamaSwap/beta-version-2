...
import { ArrowBackIcon, ArrowForwardIcon, Box, Flex, LinkExternal, Radio, Skeleton, Text } from '@kazamaswap/uikit'
...
const DataRow: React.FC<{ transaction: Transaction }> = ({ transaction }) => {
  ...
  return (
    <><ResponsiveGrid>
      ...
      <Text color="text">${formatAmount(transaction.amountUSD)}</Text>
      <Text>
...
const LiqTransTable: React.FC<{
  ...
  return (
    <Wrapper>
      ...
      <TableWrapper>
        <ResponsiveGrid>
          <Text color="#93acd3" fontSize="14px" bold textTransform="uppercase">
            {t('Action')}
          </Text>
        ...
        {transactions ? (
          <>
            ...
            <PageButtons>
              ...
              >
                <ArrowBackIcon color={page === 1 ? 'textDisabled' : '#93acd3'} />
              </Arrow>
              ...
              >
                <ArrowForwardIcon color={page === maxPage ? 'textDisabled' : '#93acd3'} />
              </Arrow>
            </PageButtons>
          </>
        ) : (
