import { Flex, TooltipText, useTooltip } from '@kazamaswap/uikit'
...
const AprRow: React.FC<React.PropsWithChildren<AprRowProps>> = ({
  ...
  const tooltipContent = vaultKey
    ? t('APY includes compounding, APR doesn’t. This pool’s KAZAMA is compounded automatically, so we show APY.')
