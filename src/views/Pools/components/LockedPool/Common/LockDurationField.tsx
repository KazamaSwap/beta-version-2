...
import { Text, Flex, Button, Input, Box, Message, MessageText } from '@kazamaswap/uikit'
      ...
      <Box mb="16px">
        ...
        <Flex flexWrap="wrap">
          {DURATIONS.map((week) => {
            ...
            return (
              <KazamaTextButton
                ...
                variant={weekSeconds === duration ? 'primary' : 'tertiary'}
              >
                {week}W
              </KazamaTextButton>
            )
          ...
          <KazamaTextButton
            ...
            variant={isMaxSelected ? 'primary' : 'tertiary'}
          >
            {t('Max')}
          </KazamaTextButton>
        </Flex>
