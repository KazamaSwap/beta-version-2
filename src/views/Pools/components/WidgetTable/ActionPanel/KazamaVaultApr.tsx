import { Box, Button, Flex, Skeleton, Text, CalculateIcon, useModal } from '@kazamaswap/uikit'
...
interface KazamaVaultAprProps {
  pool: DeserializedPool
  userData: DeserializedVaultUser
  vaultPosition: VaultPosition
}

const KazamaVaultApr: React.FC<React.PropsWithChildren<KazamaVaultAprProps>> = ({ pool, userData, vaultPosition }) => {
