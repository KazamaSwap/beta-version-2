...
import { Flex, Link, Skeleton, Text, TimerIcon } from '@kazamaswap/uikit'
...
const EndsInCell: React.FC<React.PropsWithChildren<FinishCellProps>> = ({ pool }) => {
  ...
  const showLoading = isLoadingPublicData && !isKazamaPool && !isFinished
  return (
