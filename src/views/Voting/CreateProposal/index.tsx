...
import {
    AutoRenewIcon, Box, Breadcrumbs, Button, Card, CardBody, CardHeader, Flex, Heading, Input,
    LinkExternal, ReactMarkdown, Text, useModal
} from '@kazamaswap/uikit';
import truncateHash from '@kazamaswap/utils/truncateHash';
import { useWeb3LibraryContext, useWeb3React } from '@kazamaswap/wagmi';
import snapshot from '@snapshot-labs/snapshot.js';

import Layout from '../components/Layout';
import VoteDetailsModal from '../components/VoteDetailsModal';
import { ADMINS, KAZAMA_SPACE, VOTE_THRESHOLD } from '../config';
