...
import { useKazamaSenshiOnSaleNfts } from '../../../../hooks/useKazamaSenshiOnSaleNfts'
...
const ForSaleTableCard: React.FC<React.PropsWithChildren<ForSaleTableCardProps>> = ({
  ...
  const {
    ...
    isLastPage,
    isValidating,
  } = useKazamaSenshiOnSaleNfts(senshiId, nftMetadata, itemsPerPage * 10)
  ...
  return (
    <StyledCard hasManyPages>
      ...
      >
        ...
        <UpdateIndicator isFetchingKazamaSenshis={isValidating} />
      </Grid>
