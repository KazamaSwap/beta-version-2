...
interface MainKazamaSenshiCardProps {
  cheapestNft: NftToken
  nothingForSaleSenshi: NftToken
  onSuccessSale: () => void
}

const MainKazamaSenshiCard: React.FC<React.PropsWithChildren<MainKazamaSenshiCardProps>> = ({
  cheapestNft,
  nothingForSaleSenshi,
  onSuccessSale,
}) => {
  ...
  const nftToDisplay = cheapestNft || nothingForSaleSenshi
...
export default MainKazamaSenshiCard
