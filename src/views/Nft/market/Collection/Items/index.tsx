...
import { Box, Flex, Text } from '@kazamaswap/uikit'
import { useGetCollection } from 'state/nftMarket/hooks'
import { useTranslation } from '@kazamaswap/localization'
import Select, { OptionProps } from 'components/Select/Select'
import Container from 'components/Layout/Container'
import { kazamaSenshisAddress } from '../../constants'
import KazamaSenshisCollectionNfts from './KazamaSenshisCollectionNfts'
    ...
    <>
      {isKSCollection ? (
        <Container mb="24px">
          ...
          <KazamaSenshisCollectionNfts address={collection?.address} sortBy={sortBy} />
        </Container>
      ) : (
