import { Flex, Grid, Text, Button, Link, BinanceIcon, LinkExternal, useModal } from '@kazamaswap/uikit'
...
const SellStage: React.FC<React.PropsWithChildren<SellStageProps>> = ({
  ...
  const itemPageUrlId =
    nftToSell.collectionAddress.toLowerCase() === kazamaSenshisAddress.toLowerCase()
