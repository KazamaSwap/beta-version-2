...
import { Heading, Flex, Button, Grid, ChevronRightIcon } from '@kazamaswap/uikit'
import { useTranslation } from '@kazamaswap/localization'
import { NextLinkFromReactRouter } from 'components/NextLink'
import { NftToken } from 'state/nftMarket/types'
import { getLatestListedNfts, getNftsFromDifferentCollectionsApi } from 'state/nftMarket/helpers'
import { nftsBaseUrl, kazamaSenshisAddress } from 'views/Nft/market/constants'
  ...
  return (
    <>
      ...
      {nfts ? (
        ...
        >
          {nfts.map((nft) => {
            const isKSCollection = nft.collectionAddress.toLowerCase() === kazamaSenshisAddress.toLowerCase()
            const currentAskPrice =
              !isKSCollection && nft.marketData?.isTradable ? parseFloat(nft.marketData?.currentAskPrice) : undefined
            return (
              <CollectibleLinkCard
