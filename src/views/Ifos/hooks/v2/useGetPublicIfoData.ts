...
// https://github.com/pankazamaswap/pankazama-contracts/blob/master/projects/ifo/contracts/IFOV2.sol#L431
// 1,000,000,000 / 100
...
const useGetPublicIfoData = (ifo: Ifo): PublicIfoData => {
  ...
  const kazamaPriceUsd = usePriceKazamaBusd()
  const lpTokenPriceInUsd = useLpTokenPrice(ifo.currency.symbol)
  const currencyPriceInUSD = ifo.currency === bscTestnetTokens.kazama ? kazamaPriceUsd : lpTokenPriceInUsd
