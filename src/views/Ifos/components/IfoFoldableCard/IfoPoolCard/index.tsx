...
import { useTranslation, ContextApi } from '@kazamaswap/localization'
import { Box, Card, CardBody, CardHeader, Flex, HelpIcon, Text, useTooltip } from '@kazamaswap/uikit'
...
export const cardConfig = (
  ...
  switch (poolId) {
    case PoolIds.poolBasic:
      if (meta?.version >= 3.1) {
        const MSG_MAP = {
          needQualifiedNFT: t('Set KazamaSquad NFT as your profile avatar.'),
          needQualifiedPoints: t('Reach a certain Kazama profile points threshold.'),
        }
