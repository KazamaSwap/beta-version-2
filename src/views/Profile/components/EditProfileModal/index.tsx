import { InjectedModalProps, Modal } from '@kazamaswap/uikit'
import { useTranslation, ContextApi } from '@kazamaswap/localization'
import useEditProfile, { Views } from './reducer'
import StartView from './StartView'
import PauseProfileView from './PauseProfileView'
import ChangeProfilePicView from './ChangeProfilePicView'
import ApproveKazamaView from './ApproveKazamaView'
  ...
  return (
    <Modal title={viewTitle(t, currentView)} onBack={handleBack} onDismiss={onDismiss} hideCloseButton={!isStartView}>
      <div style={{ maxWidth: '400px' }}>
        ...
        {currentView === Views.APPROVE && <ApproveKazamaView goToChange={goToChange} onDismiss={onDismiss} />}
      </div>
    </Modal>
  )
}
