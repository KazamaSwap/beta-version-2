...
import { Button, Box, InjectedModalProps, Text, Skeleton } from '@kazamaswap/uikit'
...
const ChangeProfilePicPage: React.FC<React.PropsWithChildren<ChangeProfilePicPageProps>> = ({
  ...
  console.log('debug nft', selectedNft)
    ...
    <>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {t('Make sure you have a Kazama Collectible in your wallet and try again!')}
          </Text>
        </>
      )}
