...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@kazamaswap/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'KAZAMA card' },
    { src: 'green', alt: 'Green KAZAMA card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'KAZAMA card' },
  ],
}
