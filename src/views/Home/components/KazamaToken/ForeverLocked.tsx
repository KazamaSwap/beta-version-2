import { Flex, Heading, Skeleton, Text, CardBody } from '@kazamaswap/uikit'
  ...
  return (
    <StyledCardBody>
      ...
      <Text fontSize="16px" bold color="#F4EEFF">{t('Forever Locked')}</Text>
        ...
        {kazamaLockedValue ? (
          <PrintText color="warning">{t('$%totalUsdLocked%', { totalUsdLocked: kazamaLockedString })}</PrintText>
        ) : (
