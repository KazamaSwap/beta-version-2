...
import { Button, AutoRenewIcon } from '@kazamaswap/uikit'
...
import { useVaultPoolByKeyV1, ifoPoolV1Contract, kazamaVaultAddress } from 'views/Migration/hook/V1/Pool/useFetchIfoPool'
...
const UnstakeButton: React.FC<React.PropsWithChildren<UnstakeButtonProps>> = ({ pool }) => {
  ...
  const vaultPoolContract = useMemo(() => {
    return vaultKey === VaultKey.KazamaVaultV1
      ? getContract({ abi: kazamaVaultAbi, address: kazamaVaultAddress, signer })
