...
const PoolRow: React.FC<React.PropsWithChildren<PoolRowProps>> = ({ pool, account }) => {
  ...
  const { totalKazamaInVault } = useVaultPoolByKey(pool.vaultKey)
  ...
  return (
    <>
      <StyledRow role="row" onClick={toggleExpanded}>
        ...
        {isLargerScreen && <TotalStakedCell pool={pool} totalKazamaInVault={totalKazamaInVault} kazamaInVaults={BIG_ZERO} />}
