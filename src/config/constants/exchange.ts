...
import { ChainId, JSBI, Percent, Token, WBNB, WNATIVE } from '@kazamaswap/sdk';
import { bscTestnetTokens, bscTokens, BUSD, USDC, USDT } from '@kazamaswap/tokens';
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.kazama, bscTestnetTokens.busd],
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC]: [bscTokens.busd, bscTokens.kazama, bscTokens.btcb],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.kazama, bscTestnetTokens.busd, bscTestnetTokens.usdt],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.RINKEBY]: [USDC[ChainId.RINKEBY], WNATIVE[ChainId.RINKEBY], BUSD[ChainId.RINKEBY]],
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
  [ChainId.BSC]: [bscTokens.wbnb, bscTokens.dai, bscTokens.busd, bscTokens.usdt, bscTokens.kazama],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.kazama, bscTestnetTokens.busd],
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.BSC]: [
    [bscTokens.kazama, bscTokens.wbnb],
...
// KAZAMA
export const DEFAULT_OUTPUT_CURRENCY = '0x0f48757b9B9b5F04416824FDF1F812dDbedB54E7'
