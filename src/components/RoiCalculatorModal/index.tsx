              ...
              <Flex alignItems="center">
                ...
                <Flex flex="6">
                  <FullWidthButtonMenu
                    ...
                    scale="sm"
                  >
                    <ButtonMenuItem><KazamaTextButton>{t('1D')}</KazamaTextButton></ButtonMenuItem>
                    <ButtonMenuItem><KazamaTextButton>{t('7D')}</KazamaTextButton></ButtonMenuItem>
                    <ButtonMenuItem><KazamaTextButton>{t('14D')}</KazamaTextButton></ButtonMenuItem>
                    <ButtonMenuItem><KazamaTextButton>{t('30D')}</KazamaTextButton></ButtonMenuItem>
                  </FullWidthButtonMenu>
                </Flex>
              </Flex>
            </>
