...
import { Text, Flex, Box, CloseIcon, IconButton, useMatchBreakpoints } from '@kazamaswap/uikit'
    ...
    <Container className="warning-banner">
      {isMobile || isMd ? (
        ...
        <>
          <InnerContainer>
            <img
              src="/images/decorations/phishing-warning-senshi.webp"
              alt="phishing-warning"
              width="92px"
              onError={(e) => {
                const fallbackSrc = '/images/decorations/phishing-warning-senshi.png'
