...
import { Image, Flex, Text, EarnFilledIcon, EarnFillIcon, Modal, useModal, AutoRenewIcon, Button, Input } from '@kazamaswap/uikit'
              ...
              <MessageContent>
                <div className="message-header">
                  <Flex flexDirection="row">
                    <Flex>
                    <div>
                  <NextLinkFromReactRouter to={`/profile/${sender?.address}`}>
                ...
                {getAllMessage().map((_message) => {
                  ...
                  return (<div className="message-content invalid">invalid link</div>)

                  if (_message.message.startsWith('http') && _message.message.endsWith('.gif'))
                  return (<div className="message-content gif-preview"><img style={{borderRadius: "10px", width: "96%"}} src={_message.message}></img></div>)
...
const MessageContent = styled.div`
  ...
  .message-header {
    ...
    .kraken-badge {
      ...
      border: 2px solid;
      border-color: #f79418;
      background: rgba(247, 147, 24, 0.219);
      box-shadow: none;
      color: #fff;
      margin-left: 8px;
      font-size: 12px;
