...
import { ArrowDropDownIcon, Box, BoxProps, Text, ChevronDownIcon } from '@kazamaswap/uikit'
...
const SelectFarm: React.FunctionComponent<React.PropsWithChildren<SelectProps>> = ({
  options,
  onOptionChange,
